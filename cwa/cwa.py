...
def generatePayload(eventDescription: CwaEventDescription):
	...
	payload.locationData.startTimestamp = int(eventDescription.startDateTime.timestamp()) if eventDescription.startDateTime else 0
	payload.locationData.endTimestamp = int(eventDescription.endDateTime.timestamp()) if eventDescription.endDateTime else 0
